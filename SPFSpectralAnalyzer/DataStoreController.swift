...
final class DataStoreController: ObservableObject {
    ...
    func runCloudKitSchemaInit() {
        ...
        SPFSpectralAnalyzerApp.initializeCloudKitSchemaIfNeeded(schema: schema, configuration: configuration)
    }
    #endif
    ...
    init() {
        ...
        NotificationCenter.default.addObserver(
            forName: platformDidBecomeActiveNotification,
            object: nil,
            queue: .main
        ) { [weak self] _ in
    ...
    private func migrateLocalDataToCloud(
        ...
        do {
            ...
            for dataset in datasets {
                ...
                let dsIsPostIrradiation = dataset.isPostIrradiation
                ...
                let newDataset = StoredDataset(
                    ...
                    isPostIrradiation: dsIsPostIrradiation
                )
