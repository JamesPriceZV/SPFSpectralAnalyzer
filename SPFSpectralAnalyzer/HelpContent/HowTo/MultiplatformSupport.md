...
## Overview
SPF Spectral Analyzer runs natively on macOS, iOS, and iPadOS from a single codebase. The interface adapts to each platform while providing access to the full analysis toolkit.
