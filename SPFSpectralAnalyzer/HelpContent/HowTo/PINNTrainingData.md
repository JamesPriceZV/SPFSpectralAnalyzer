...
## Overview
The PINN Training Data System is a universal physics-informed spectral data pipeline that covers 25 spectral modalities. It downloads free reference spectra from public databases, applies physics-based synthesis to generate training records, and exports datasets for CoreML model training.

Access the Training Data Dashboard from the ML Training tab to monitor progress across all modalities.

## Supported Modalities (25)
...
3. Click "Prepare All" to begin downloading references and synthesizing training records for all 25 modalities
...
### Feature Vectors
Each modality defines a fixed-size feature vector (52 to 1212 features depending on the technique). Features include:
...
### Parsers
Seven specialized parsers handle different data formats:
