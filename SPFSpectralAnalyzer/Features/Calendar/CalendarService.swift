...
final class CalendarService {
    ...
    func scheduleCalibrationReminder(
        ...
        event.notes = notes ?? "Scheduled calibration reminder for \(instrumentName) from SPF Spectral Analyzer."
    ...
    func scheduleIncubationTimer(
        ...
        event.notes = notes ?? "Incubation period complete. Re-test sample \"\(sampleName)\" from SPF Spectral Analyzer."
        event.calendar = eventStore.defaultCalendarForNewEvents
