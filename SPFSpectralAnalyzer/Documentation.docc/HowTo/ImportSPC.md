...
- Galactic/Thermo files are parsed with ``GalacticSPCParser``, which handles evenly-spaced and per-subfile X data, multi-subfile layouts, and both integer-scaled and IEEE float Y values.
