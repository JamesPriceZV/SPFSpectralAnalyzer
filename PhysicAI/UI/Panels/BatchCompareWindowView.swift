...
struct BatchCompareWindowView: View {
    ...
    private var batchTableSnapshot: some View {
        VStack(alignment: .leading, spacing: 4) {
            ...
            Text("PhysicAI — \(model.snapshotDate.formatted(date: .abbreviated, time: .shortened))")
                .font(.caption2)
                .foregroundColor(.gray)
                .padding(.top, 4)
        }
    ...
    func generateHTMLTable() -> String {
        ...
        <p style="font-size:11px;color:#888;margin-top:8px;">Generated by PhysicAI &mdash; \(model.snapshotDate.formatted(date: .abbreviated, time: .shortened))</p>
        """
