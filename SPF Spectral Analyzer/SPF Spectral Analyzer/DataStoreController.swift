...
final class DataStoreController: ObservableObject {
    ...
    private let schema = Schema([StoredDataset.self, StoredSpectrum.self, Item.self] as [any PersistentModel.Type])
        ...
        do {
            ...
            for dataset in datasets {
                ...
                let newDataset = StoredDataset(
                    ...
                    headerInfoData: dataset.headerInfoData,
                    skippedDataJSON: dataset.skippedDataJSON,
                    warningsJSON: dataset.warningsJSON,
                    spectra: []
                )
