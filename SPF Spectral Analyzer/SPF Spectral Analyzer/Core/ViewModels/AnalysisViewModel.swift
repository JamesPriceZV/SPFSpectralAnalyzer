...
final class AnalysisViewModel {
    ...
    var selectionScopedAnalysisSpectra: [ShimadzuSpectrum] {
        ...
        return selectedSpectrumIndices.sorted().compactMap { index in
    ...
    func rebuildCaches(spfConfig: SPFConfiguration? = nil,
        ...
        let dashboardSnapshots = analysis.map { (name: $0.name, x: $0.x, y: $0.y) }
