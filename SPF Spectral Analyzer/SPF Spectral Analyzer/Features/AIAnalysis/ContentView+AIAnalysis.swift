...
"""
    ...
    func saveValidationLogToFile() {
        ...
        panel.nameFieldStringValue = timestampedFileName("validation-log.txt")
    ...
    func aiCacheKey() -> String {
        ...
        return "\(endpoint)|\(model)|\(scope)|\(preset)|\(analysis.yAxisMode.rawValue)|\(structuredFlag)|\(promptSignature)|\(names)"
    }
