...
struct InstrumentRegistryView: View {
    ...
    @State private var scheduleCalibrationEvent: ScheduleEventSheet.EventType?
    ...
    var body: some View {
        ...
        .sheet(item: $scheduleCalibrationEvent) { eventType in
    ...
    private func instrumentRow(_ instrument: StoredInstrument) -> some View {
        ...
        .contextMenu {
            ...
            Button {
                scheduleCalibrationEvent = .calibration(instrumentName: instrument.displayName)
            } label: {
                Label("Schedule Calibration", systemImage: "calendar.badge.plus")
            }
            Divider()
