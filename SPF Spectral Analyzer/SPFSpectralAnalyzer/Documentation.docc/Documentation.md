@Article(
    title: "SPF Spectral Analyzer Documentation"
)

## Overview
SPF Spectral Analyzer imports Shimadzu SPC spectral files, validates spectra, and exports results in standard formats suitable for reporting and downstream analysis. The main UI is ``ContentView`` and most workflows occur inside the Import, Analyze, AI Analysis, and Export tabs.
